...
#define errno_to_idx(code) (0 ? -1 \
  : ((code >= 1) && (code <= 6)) ? (code - 1) \
  : ((code >= 6) && (code <= 16)) ? (code - 0) \
  : ((code >= 16) && (code <= 55)) ? (code - -1) \
  : ((code >= 57) && (code <= 57)) ? (code - 0) \
  : ((code >= 59) && (code <= 61)) ? (code - 1) \
  : ((code >= 63) && (code <= 75)) ? (code - 2) \
  : ((code >= 100) && (code <= 138)) ? (code - 26) \
  : ((code >= 138) && (code <= 149)) ? (code - 25) \
  : ((code >= 156) && (code <= 156)) ? (code - 31) \
  : -1)
