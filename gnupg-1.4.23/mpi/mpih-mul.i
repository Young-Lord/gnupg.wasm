     ...
     mpi_ptr_t vp, mpi_size_t size)
{
    ...
    if( v_limb <= 1 ) {
 if( v_limb == 1 )
     do { mpi_size_t _i; for( _i = 0; _i < (size); _i++ ) (prodp)[_i] = (up)[_i]; } while(0);
 else
     do { int _i; for( _i = 0; _i < (size); _i++ ) (prodp)[_i] = 0; } while (0);
 cy = 0;
    }
    else
...
# 133 "mpih-mul.c"
      ...
      do { if( (esize) < 16 ) mul_n_basecase (prodp, up, vp, esize); else mul_n (prodp, up, vp, esize, tspace); } while (0);;
...
# 158 "mpih-mul.c"
 ...
 do { if( (hsize) < 16 ) mul_n_basecase (prodp + size, up + hsize, vp + hsize, hsize); else mul_n (prodp + size, up + hsize, vp + hsize, hsize, tspace); } while (0);;
 ...
 do { if( (hsize) < 16 ) mul_n_basecase (tspace, prodp, prodp + hsize, hsize); else mul_n (tspace, prodp, prodp + hsize, hsize, tspace + size); } while (0);;


 do { mpi_size_t _i; for( _i = 0; _i < (hsize); _i++ ) (prodp + hsize)[_i] = (prodp + size)[_i]; } while(0);
 ...
 do { if( (hsize) < 16 ) mul_n_basecase (tspace, up, vp, hsize); else mul_n (tspace, up, vp, hsize, tspace + size); } while (0);;
 ...
 do { mpi_size_t _i; for( _i = 0; _i < (hsize); _i++ ) (prodp)[_i] = (tspace)[_i]; } while(0);
...
# 282 "mpih-mul.c"
 ...
 do { if ((esize) < 16) mpih_sqr_n_basecase (prodp, up, esize); else mpih_sqr_n (prodp, up, esize, tspace); } while (0);;
 ...
 do { if ((hsize) < 16) mpih_sqr_n_basecase (prodp + size, up + hsize, hsize); else mpih_sqr_n (prodp + size, up + hsize, hsize, tspace); } while (0);;
 ...
 do { if ((hsize) < 16) mpih_sqr_n_basecase (tspace, prodp, hsize); else mpih_sqr_n (tspace, prodp, hsize, tspace + size); } while (0);;
 ...
 do { if ((hsize) < 16) mpih_sqr_n_basecase (tspace, up, hsize); else mpih_sqr_n (tspace, up, hsize, tspace + size); } while (0);;
       ...
       struct karatsuba_ctx *ctx )
{
 ...
 ctx->tspace_size = vsize;
    ...
    do { if( (vsize) < 16 ) mul_n_basecase (prodp, up, vp, vsize); else mul_n (prodp, up, vp, vsize, ctx->tspace); } while (0);;
 ...
 do {
     do { if( (vsize) < 16 ) mul_n_basecase (ctx->tp, up, vp, vsize); else mul_n (ctx->tp, up, vp, vsize, ctx->tspace); } while (0);;
         ...
         mpi_ptr_t vp, mpi_size_t vsize)
{
 ...
 if( v_limb <= 1 ) {
     if( v_limb == 1 )
  do { mpi_size_t _i; for( _i = 0; _i < (usize); _i++ ) (prodp)[_i] = (up)[_i]; } while(0);
     else
  do { int _i; for( _i = 0; _i < (usize); _i++ ) (prodp)[_i] = 0; } while (0);
     cy = 0;
 }
 else
