...
# 1 "./mpi-inline.h" 1
# 42 "./mpi-inline.h"
extern inline __attribute__ ((__gnu_inline__)) mpi_limb_t
...
# 66 "mpih-div.c"
    if( 1 > (2 * 1 + 6)
 && (1 - (2 * 1 + 6)) * dividend_size > 1 ) {
 int normalization_steps;

 do { UWtype __xr = (divisor_limb); UWtype __a; if ((8*(4)) <= 32) { __a = __xr < ((UWtype) 1 << 2*((8*(4)) / 4)) ? (__xr < ((UWtype) 1 << ((8*(4)) / 4)) ? 0 : ((8*(4)) / 4)) : (__xr < ((UWtype) 1 << 3*((8*(4)) / 4)) ? 2*((8*(4)) / 4) : 3*((8*(4)) / 4)); } else { for (__a = (8*(4)) - 8; __a > 0; __a -= 8) if (((__xr >> __a) & 0xff) != 0) break; } (normalization_steps) = (8*(4)) - (__clz_tab[__xr >> __a] + __a); } while (0);
 if( normalization_steps ) {
  ...
  do { UWtype __d1, __d0, __q1, __q0, __r1, __r0, __m; __d1 = ((UWtype) (divisor_limb) >> ((8*(4)) / 2)); __d0 = ((UWtype) (divisor_limb) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __r1 = (-divisor_limb) % __d1; __q1 = (-divisor_limb) / __d1; __m = (UWtype) __q1 * __d0; __r1 = __r1 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (0) >> ((8*(4)) / 2)); if (__r1 < __m) { __q1--, __r1 += (divisor_limb); if (__r1 >= (divisor_limb)) if (__r1 < __m) __q1--, __r1 += (divisor_limb); } __r1 -= __m; __r0 = __r1 % __d1; __q0 = __r1 / __d1; __m = (UWtype) __q0 * __d0; __r0 = __r0 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); if (__r0 < __m) { __q0--, __r0 += (divisor_limb); if (__r0 >= (divisor_limb)) if (__r0 < __m) __q0--, __r0 += (divisor_limb); } __r0 -= __m; (divisor_limb_inverted) = (UWtype) __q1 * ((UWtype) 1 << ((8*(4)) / 2)) | __q0; (dummy) = __r0; } while (0);
  ...
  n0 = dividend_ptr[i];
  do { mpi_limb_t _ql __attribute__ ((unused)); mpi_limb_t _q, _r; mpi_limb_t _xh, _xl; do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = ((r)), __v = ((divisor_limb_inverted)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_q) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_ql) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); _q += (r); do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = (_q), __v = ((divisor_limb)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_xh) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_xl) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); do { UWtype __x; __x = ((((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps))))) - (_xl); (_xh) = ((r)) - (_xh) - (__x > ((((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps)))))); (_r) = __x; } while (0); if( _xh ) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; if( _xh) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; } } if( _r >= (divisor_limb) ) { _r -= (divisor_limb); _q++; } (r) = _r; (dummy) = _q; } while (0);



  n1 = n0;
     }
     do { mpi_limb_t _ql __attribute__ ((unused)); mpi_limb_t _q, _r; mpi_limb_t _xh, _xl; do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = ((r)), __v = ((divisor_limb_inverted)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_q) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_ql) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); _q += (r); do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = (_q), __v = ((divisor_limb)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_xh) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_xl) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); do { UWtype __x; __x = ((n1 << normalization_steps)) - (_xl); (_xh) = ((r)) - (_xh) - (__x > ((n1 << normalization_steps))); (_r) = __x; } while (0); if( _xh ) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; if( _xh) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; } } if( _r >= (divisor_limb) ) { _r -= (divisor_limb); _q++; } (r) = _r; (dummy) = _q; } while (0);
  ...
  i--;
     ...
     for( ; i >= 0; i--) {
  n0 = dividend_ptr[i];
  do { mpi_limb_t _ql __attribute__ ((unused)); mpi_limb_t _q, _r; mpi_limb_t _xh, _xl; do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = ((r)), __v = ((divisor_limb_inverted)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_q) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_ql) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); _q += (r); do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = (_q), __v = ((divisor_limb)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_xh) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_xl) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); do { UWtype __x; __x = ((n0)) - (_xl); (_xh) = ((r)) - (_xh) - (__x > ((n0))); (_r) = __x; } while (0); if( _xh ) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; if( _xh) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; } } if( _r >= (divisor_limb) ) { _r -= (divisor_limb); _q++; } (r) = _r; (dummy) = _q; } while (0);
 ...
 if( 1 ) {
  ...
  for(i = dividend_size - 2; i >= 0; i--) {
      n0 = dividend_ptr[i];
      do { UWtype __d1, __d0, __q1, __q0, __r1, __r0, __m; __d1 = ((UWtype) (divisor_limb) >> ((8*(4)) / 2)); __d0 = ((UWtype) (divisor_limb) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __r1 = (r) % __d1; __q1 = (r) / __d1; __m = (UWtype) __q1 * __d0; __r1 = __r1 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps)))) >> ((8*(4)) / 2)); if (__r1 < __m) { __q1--, __r1 += (divisor_limb); if (__r1 >= (divisor_limb)) if (__r1 < __m) __q1--, __r1 += (divisor_limb); } __r1 -= __m; __r0 = __r1 % __d1; __q0 = __r1 / __d1; __m = (UWtype) __q0 * __d0; __r0 = __r0 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps)))) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); if (__r0 < __m) { __q0--, __r0 += (divisor_limb); if (__r0 >= (divisor_limb)) if (__r0 < __m) __q0--, __r0 += (divisor_limb); } __r0 -= __m; (dummy) = (UWtype) __q1 * ((UWtype) 1 << ((8*(4)) / 2)) | __q0; (r) = __r0; } while (0);



      n1 = n0;
  }
  do { UWtype __d1, __d0, __q1, __q0, __r1, __r0, __m; __d1 = ((UWtype) (divisor_limb) >> ((8*(4)) / 2)); __d0 = ((UWtype) (divisor_limb) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __r1 = (r) % __d1; __q1 = (r) / __d1; __m = (UWtype) __q1 * __d0; __r1 = __r1 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (n1 << normalization_steps) >> ((8*(4)) / 2)); if (__r1 < __m) { __q1--, __r1 += (divisor_limb); if (__r1 >= (divisor_limb)) if (__r1 < __m) __q1--, __r1 += (divisor_limb); } __r1 -= __m; __r0 = __r1 % __d1; __q0 = __r1 / __d1; __m = (UWtype) __q0 * __d0; __r0 = __r0 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (n1 << normalization_steps) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); if (__r0 < __m) { __q0--, __r0 += (divisor_limb); if (__r0 >= (divisor_limb)) if (__r0 < __m) __q0--, __r0 += (divisor_limb); } __r0 -= __m; (dummy) = (UWtype) __q1 * ((UWtype) 1 << ((8*(4)) / 2)) | __q0; (r) = __r0; } while (0);
  ...
  mpi_ptr_t dp, mpi_size_t dsize)
{
      ...
      case 2:
 {
  ...
  do { UWtype __x; __x = (n0) - (d0); (n1) = (n1) - (d1) - (__x > (n0)); (n0) = __x; } while (0);
  most_significant_q_limb = 1;
     }
  ...
  if( n1 == d1 ) {
      ...
      r = n0 + d1;
      if( r < d1 ) {
   do { UWtype __x; __x = (np[0]) + (d0); (n1) = (r - d0) + (0) + (__x < (np[0])); (n0) = __x; } while (0);
   qp[i] = q;
   continue;
      }
      n1 = d0 - (d0 != 0?1:0);
  ...
  if( n1 > r || (n1 == r && n0 > n2) ) {
      ...
      q--;
      do { UWtype __x; __x = (n0) - (d0); (n1) = (n1) - (0) - (__x > (n0)); (n0) = __x; } while (0);
      r += d1;
      if( r >= d1 )
   goto q_test;
  }
  ...
  qp[i] = q;
  do { UWtype __x; __x = (n2) - (n0); (n1) = (r) - (n1) - (__x > (n2)); (n0) = __x; } while (0);
     }
     np[1] = n1;
     np[0] = n0;
 }
      ...
      default:
 {
  ...
  if( i >= qextra_limbs ) {
      ...
      n2 = np[dsize - 1];
      do { mpi_size_t _i; for( _i = (dsize - 1)-1; _i >= 0; _i--) (np + 1)[_i] = (np)[_i]; } while(0);
      np[0] = 0;
  }
...
# 414 "mpih-div.c"
 ...
 if( normalization_steps ) {
  ...
  do { UWtype __d1, __d0, __q1, __q0, __r1, __r0, __m; __d1 = ((UWtype) (divisor_limb) >> ((8*(4)) / 2)); __d0 = ((UWtype) (divisor_limb) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __r1 = (-divisor_limb) % __d1; __q1 = (-divisor_limb) / __d1; __m = (UWtype) __q1 * __d0; __r1 = __r1 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (0) >> ((8*(4)) / 2)); if (__r1 < __m) { __q1--, __r1 += (divisor_limb); if (__r1 >= (divisor_limb)) if (__r1 < __m) __q1--, __r1 += (divisor_limb); } __r1 -= __m; __r0 = __r1 % __d1; __q0 = __r1 / __d1; __m = (UWtype) __q0 * __d0; __r0 = __r0 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); if (__r0 < __m) { __q0--, __r0 += (divisor_limb); if (__r0 >= (divisor_limb)) if (__r0 < __m) __q0--, __r0 += (divisor_limb); } __r0 -= __m; (divisor_limb_inverted) = (UWtype) __q1 * ((UWtype) 1 << ((8*(4)) / 2)) | __q0; (dummy) = __r0; } while (0);
     ...
     for( i = dividend_size - 2; i >= 0; i--) {
  n0 = dividend_ptr[i];
  do { mpi_limb_t _ql __attribute__ ((unused)); mpi_limb_t _q, _r; mpi_limb_t _xh, _xl; do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = ((r)), __v = ((divisor_limb_inverted)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_q) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_ql) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); _q += (r); do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = (_q), __v = ((divisor_limb)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_xh) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_xl) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); do { UWtype __x; __x = ((((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps))))) - (_xl); (_xh) = ((r)) - (_xh) - (__x > ((((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps)))))); (_r) = __x; } while (0); if( _xh ) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; if( _xh) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; } } if( _r >= (divisor_limb) ) { _r -= (divisor_limb); _q++; } (r) = _r; (quot_ptr[i + 1]) = _q; } while (0);



  n1 = n0;
     }
     do { mpi_limb_t _ql __attribute__ ((unused)); mpi_limb_t _q, _r; mpi_limb_t _xh, _xl; do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = ((r)), __v = ((divisor_limb_inverted)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_q) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_ql) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); _q += (r); do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = (_q), __v = ((divisor_limb)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_xh) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_xl) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); do { UWtype __x; __x = ((n1 << normalization_steps)) - (_xl); (_xh) = ((r)) - (_xh) - (__x > ((n1 << normalization_steps))); (_r) = __x; } while (0); if( _xh ) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; if( _xh) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; } } if( _r >= (divisor_limb) ) { _r -= (divisor_limb); _q++; } (r) = _r; (quot_ptr[0]) = _q; } while (0);
  ...
  quot_ptr[i--] = 0;
     ...
     for( ; i >= 0; i-- ) {
  n0 = dividend_ptr[i];
  do { mpi_limb_t _ql __attribute__ ((unused)); mpi_limb_t _q, _r; mpi_limb_t _xh, _xl; do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = ((r)), __v = ((divisor_limb_inverted)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_q) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_ql) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); _q += (r); do { UWtype __x0, __x1, __x2, __x3; UHWtype __ul, __vl, __uh, __vh; UWtype __u = (_q), __v = ((divisor_limb)); __ul = ((UWtype) (__u) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __uh = ((UWtype) (__u) >> ((8*(4)) / 2)); __vl = ((UWtype) (__v) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __vh = ((UWtype) (__v) >> ((8*(4)) / 2)); __x0 = (UWtype) __ul * __vl; __x1 = (UWtype) __ul * __vh; __x2 = (UWtype) __uh * __vl; __x3 = (UWtype) __uh * __vh; __x1 += ((UWtype) (__x0) >> ((8*(4)) / 2)); __x1 += __x2; if (__x1 < __x2) __x3 += ((UWtype) 1 << ((8*(4)) / 2)); (_xh) = __x3 + ((UWtype) (__x1) >> ((8*(4)) / 2)); (_xl) = (((UWtype) (__x1) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)) << (8*(4))/2) + ((UWtype) (__x0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); } while (0); do { UWtype __x; __x = ((n0)) - (_xl); (_xh) = ((r)) - (_xh) - (__x > ((n0))); (_r) = __x; } while (0); if( _xh ) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; if( _xh) { do { UWtype __x; __x = (_r) - ((divisor_limb)); (_xh) = (_xh) - (0) - (__x > (_r)); (_r) = __x; } while (0); _q++; } } if( _r >= (divisor_limb) ) { _r -= (divisor_limb); _q++; } (r) = _r; (quot_ptr[i]) = _q; } while (0);
 ...
 if(1) {
  ...
  for( i = dividend_size - 2; i >= 0; i--) {
      n0 = dividend_ptr[i];
      do { UWtype __d1, __d0, __q1, __q0, __r1, __r0, __m; __d1 = ((UWtype) (divisor_limb) >> ((8*(4)) / 2)); __d0 = ((UWtype) (divisor_limb) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __r1 = (r) % __d1; __q1 = (r) / __d1; __m = (UWtype) __q1 * __d0; __r1 = __r1 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps)))) >> ((8*(4)) / 2)); if (__r1 < __m) { __q1--, __r1 += (divisor_limb); if (__r1 >= (divisor_limb)) if (__r1 < __m) __q1--, __r1 += (divisor_limb); } __r1 -= __m; __r0 = __r1 % __d1; __q0 = __r1 / __d1; __m = (UWtype) __q0 * __d0; __r0 = __r0 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (((n1 << normalization_steps) | (n0 >> ((8*(4)) - normalization_steps)))) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); if (__r0 < __m) { __q0--, __r0 += (divisor_limb); if (__r0 >= (divisor_limb)) if (__r0 < __m) __q0--, __r0 += (divisor_limb); } __r0 -= __m; (quot_ptr[i + 1]) = (UWtype) __q1 * ((UWtype) 1 << ((8*(4)) / 2)) | __q0; (r) = __r0; } while (0);



      n1 = n0;
  }
  do { UWtype __d1, __d0, __q1, __q0, __r1, __r0, __m; __d1 = ((UWtype) (divisor_limb) >> ((8*(4)) / 2)); __d0 = ((UWtype) (divisor_limb) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __r1 = (r) % __d1; __q1 = (r) / __d1; __m = (UWtype) __q1 * __d0; __r1 = __r1 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (n1 << normalization_steps) >> ((8*(4)) / 2)); if (__r1 < __m) { __q1--, __r1 += (divisor_limb); if (__r1 >= (divisor_limb)) if (__r1 < __m) __q1--, __r1 += (divisor_limb); } __r1 -= __m; __r0 = __r1 % __d1; __q0 = __r1 / __d1; __m = (UWtype) __q0 * __d0; __r0 = __r0 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (n1 << normalization_steps) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); if (__r0 < __m) { __q0--, __r0 += (divisor_limb); if (__r0 >= (divisor_limb)) if (__r0 < __m) __q0--, __r0 += (divisor_limb); } __r0 -= __m; (quot_ptr[0]) = (UWtype) __q1 * ((UWtype) 1 << ((8*(4)) / 2)) | __q0; (r) = __r0; } while (0);
 ...
 for(; i >= 0; i--) {
     n0 = dividend_ptr[i];
     do { UWtype __d1, __d0, __q1, __q0, __r1, __r0, __m; __d1 = ((UWtype) (divisor_limb) >> ((8*(4)) / 2)); __d0 = ((UWtype) (divisor_limb) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); __r1 = (r) % __d1; __q1 = (r) / __d1; __m = (UWtype) __q1 * __d0; __r1 = __r1 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (n0) >> ((8*(4)) / 2)); if (__r1 < __m) { __q1--, __r1 += (divisor_limb); if (__r1 >= (divisor_limb)) if (__r1 < __m) __q1--, __r1 += (divisor_limb); } __r1 -= __m; __r0 = __r1 % __d1; __q0 = __r1 / __d1; __m = (UWtype) __q0 * __d0; __r0 = __r0 * ((UWtype) 1 << ((8*(4)) / 2)) | ((UWtype) (n0) & (((UWtype) 1 << ((8*(4)) / 2)) - 1)); if (__r0 < __m) { __q0--, __r0 += (divisor_limb); if (__r0 >= (divisor_limb)) if (__r0 < __m) __q0--, __r0 += (divisor_limb); } __r0 -= __m; (quot_ptr[i]) = (UWtype) __q1 * ((UWtype) 1 << ((8*(4)) / 2)) | __q0; (r) = __r0; } while (0);
 }
 return r;
    }
}
