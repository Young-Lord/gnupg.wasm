...
mpi_powm (MPI res, MPI base, MPI expo, MPI mod)
{
  ...
  do { UWtype __xr = (mod->d[msize-1]); UWtype __a; if ((8*(4)) <= 32) { __a = __xr < ((UWtype) 1 << 2*((8*(4)) / 4)) ? (__xr < ((UWtype) 1 << ((8*(4)) / 4)) ? 0 : ((8*(4)) / 4)) : (__xr < ((UWtype) 1 << 3*((8*(4)) / 4)) ? 2*((8*(4)) / 4) : 3*((8*(4)) / 4)); } else { for (__a = (8*(4)) - 8; __a > 0; __a -= 8) if (((__xr >> __a) & 0xff) != 0) break; } (mod_shift_cnt) = (8*(4)) - (__clz_tab[__xr >> __a] + __a); } while (0);
  if (mod_shift_cnt)
  ...
  if ( rp == bp )
    {
      ...
      ((void)((!bp_marker) || (__assert_fail("!bp_marker", "mpi-pow.c", 473, __func__),0)));
...
# 543 "mpi-pow.c"
    ...
    e = ep[i];
    do { UWtype __xr = (e); UWtype __a; if ((8*(4)) <= 32) { __a = __xr < ((UWtype) 1 << 2*((8*(4)) / 4)) ? (__xr < ((UWtype) 1 << ((8*(4)) / 4)) ? 0 : ((8*(4)) / 4)) : (__xr < ((UWtype) 1 << 3*((8*(4)) / 4)) ? 2*((8*(4)) / 4) : 3*((8*(4)) / 4)); } else { for (__a = (8*(4)) - 8; __a > 0; __a -= 8) if (((__xr >> __a) & 0xff) != 0) break; } (c) = (8*(4)) - (__clz_tab[__xr >> __a] + __a); } while (0);
    e = (e << c) << 1;
    c = (8*(4)) - 1 - c;
    ...
    for (;;)
      if (e == 0)
      ...
      else
        {
          ...
          do { UWtype __xr = (e); UWtype __a; if ((8*(4)) <= 32) { __a = __xr < ((UWtype) 1 << 2*((8*(4)) / 4)) ? (__xr < ((UWtype) 1 << ((8*(4)) / 4)) ? 0 : ((8*(4)) / 4)) : (__xr < ((UWtype) 1 << 3*((8*(4)) / 4)) ? 2*((8*(4)) / 4) : 3*((8*(4)) / 4)); } else { for (__a = (8*(4)) - 8; __a > 0; __a -= 8) if (((__xr >> __a) & 0xff) != 0) break; } (c0) = (8*(4)) - (__clz_tab[__xr >> __a] + __a); } while (0);
          e = (e << c0);
          c -= c0;
          j += c0;
        ...
        last_step:
          do { UWtype __ctz_x = (e0); UWtype __ctz_c; do { UWtype __xr = (__ctz_x & -__ctz_x); UWtype __a; if ((8*(4)) <= 32) { __a = __xr < ((UWtype) 1 << 2*((8*(4)) / 4)) ? (__xr < ((UWtype) 1 << ((8*(4)) / 4)) ? 0 : ((8*(4)) / 4)) : (__xr < ((UWtype) 1 << 3*((8*(4)) / 4)) ? 2*((8*(4)) / 4) : 3*((8*(4)) / 4)); } else { for (__a = (8*(4)) - 8; __a > 0; __a -= 8) if (((__xr >> __a) & 0xff) != 0) break; } (__ctz_c) = (8*(4)) - (__clz_tab[__xr >> __a] + __a); } while (0); (c0) = (8*(4)) - 1 - __ctz_c; } while (0);
          e0 = (e0 >> c0) >> 1;
  ...
  ((void)((res->d == rp) || (__assert_fail("res->d == rp", "mpi-pow.c", 704, __func__),0)));
  res->nlimbs = rsize;
  res->sign = rsign;
