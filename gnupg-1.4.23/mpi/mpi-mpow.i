...
mpi_mulpowm( MPI res, MPI *basearray, MPI *exparray, MPI m)
{
 ...
 ;
    ((void)((k) || (__assert_fail("k", "mpi-mpow.c", 56, __func__),0)));
    for(t=0, i=0; (tmp=exparray[i]); i++ ) {
 j = mpi_get_nbits(tmp);
 if( j > t )
     t = j;
    }
    ((void)((i==k) || (__assert_fail("i==k", "mpi-mpow.c", 62, __func__),0)));
    ((void)((t) || (__assert_fail("t", "mpi-mpow.c", 63, __func__),0)));
    ((void)((k < 10) || (__assert_fail("k < 10", "mpi-mpow.c", 64, __func__),0)));
 ...
 ((void)((idx >= 0 && idx < (1<<k)) || (__assert_fail("idx >= 0 && idx < (1<<k)", "mpi-mpow.c", 73, __func__),0)));
 if( !G[idx] ) {
     if( !idx )
