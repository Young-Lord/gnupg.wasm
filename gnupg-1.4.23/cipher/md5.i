...
# 133 "md5.c"
    do { A += (D ^ (B & (C ^ D))) + (*cwp++) + 0xd76aa478; A = ( ((A) << (7)) | ((A) >> (32-(7))) ); A += B; } while (0);
    do { D += (C ^ (A & (B ^ C))) + (*cwp++) + 0xe8c7b756; D = ( ((D) << (12)) | ((D) >> (32-(12))) ); D += A; } while (0);
    do { C += (B ^ (D & (A ^ B))) + (*cwp++) + 0x242070db; C = ( ((C) << (17)) | ((C) >> (32-(17))) ); C += D; } while (0);
    do { B += (A ^ (C & (D ^ A))) + (*cwp++) + 0xc1bdceee; B = ( ((B) << (22)) | ((B) >> (32-(22))) ); B += C; } while (0);
    do { A += (D ^ (B & (C ^ D))) + (*cwp++) + 0xf57c0faf; A = ( ((A) << (7)) | ((A) >> (32-(7))) ); A += B; } while (0);
    do { D += (C ^ (A & (B ^ C))) + (*cwp++) + 0x4787c62a; D = ( ((D) << (12)) | ((D) >> (32-(12))) ); D += A; } while (0);
    do { C += (B ^ (D & (A ^ B))) + (*cwp++) + 0xa8304613; C = ( ((C) << (17)) | ((C) >> (32-(17))) ); C += D; } while (0);
    do { B += (A ^ (C & (D ^ A))) + (*cwp++) + 0xfd469501; B = ( ((B) << (22)) | ((B) >> (32-(22))) ); B += C; } while (0);
    do { A += (D ^ (B & (C ^ D))) + (*cwp++) + 0x698098d8; A = ( ((A) << (7)) | ((A) >> (32-(7))) ); A += B; } while (0);
    do { D += (C ^ (A & (B ^ C))) + (*cwp++) + 0x8b44f7af; D = ( ((D) << (12)) | ((D) >> (32-(12))) ); D += A; } while (0);
    do { C += (B ^ (D & (A ^ B))) + (*cwp++) + 0xffff5bb1; C = ( ((C) << (17)) | ((C) >> (32-(17))) ); C += D; } while (0);
    do { B += (A ^ (C & (D ^ A))) + (*cwp++) + 0x895cd7be; B = ( ((B) << (22)) | ((B) >> (32-(22))) ); B += C; } while (0);
    do { A += (D ^ (B & (C ^ D))) + (*cwp++) + 0x6b901122; A = ( ((A) << (7)) | ((A) >> (32-(7))) ); A += B; } while (0);
    do { D += (C ^ (A & (B ^ C))) + (*cwp++) + 0xfd987193; D = ( ((D) << (12)) | ((D) >> (32-(12))) ); D += A; } while (0);
    do { C += (B ^ (D & (A ^ B))) + (*cwp++) + 0xa679438e; C = ( ((C) << (17)) | ((C) >> (32-(17))) ); C += D; } while (0);
    do { B += (A ^ (C & (D ^ A))) + (*cwp++) + 0x49b40821; B = ( ((B) << (22)) | ((B) >> (32-(22))) ); B += C; } while (0);
# 161 "md5.c"
...
md5_final( MD5_CONTEXT *hd )
{
 ...
 memset(hd->buf, 0, 56 );
    ...
    do { *(u32*)p = hd-> B ; p += 4; } while(0);
    do { *(u32*)p = hd-> C ; p += 4; } while(0);
    do { *(u32*)p = hd-> D ; p += 4; } while(0);
