...
# 10 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/inttypes.h" 2 3
  ...
  for(t=0;t<80;t++)
    {
      ...
      t1=h+(((((e))>>(14)) | (((e))<<(64-(14)))) ^ ((((e))>>(18)) | (((e))<<(64-(18)))) ^ ((((e))>>(41)) | (((e))<<(64-(41)))))+(((e) & (f)) ^ ((~(e)) & (g)))+k[t]+w[t];
...
sha512_final(SHA512_CONTEXT *hd)
{
 ...
 memset(hd->buf, 0, 112 );
    ...
    p = hd->buf;
# 341 "sha512.c"
    do { *p++ = hd->h0 >> 56; *p++ = hd->h0 >> 48; *p++ = hd->h0 >> 40; *p++ = hd->h0 >> 32; *p++ = hd->h0 >> 24; *p++ = hd->h0 >> 16; *p++ = hd->h0 >> 8; *p++ = hd->h0; } while(0);
    do { *p++ = hd->h1 >> 56; *p++ = hd->h1 >> 48; *p++ = hd->h1 >> 40; *p++ = hd->h1 >> 32; *p++ = hd->h1 >> 24; *p++ = hd->h1 >> 16; *p++ = hd->h1 >> 8; *p++ = hd->h1; } while(0);
    do { *p++ = hd->h2 >> 56; *p++ = hd->h2 >> 48; *p++ = hd->h2 >> 40; *p++ = hd->h2 >> 32; *p++ = hd->h2 >> 24; *p++ = hd->h2 >> 16; *p++ = hd->h2 >> 8; *p++ = hd->h2; } while(0);
    do { *p++ = hd->h3 >> 56; *p++ = hd->h3 >> 48; *p++ = hd->h3 >> 40; *p++ = hd->h3 >> 32; *p++ = hd->h3 >> 24; *p++ = hd->h3 >> 16; *p++ = hd->h3 >> 8; *p++ = hd->h3; } while(0);
    do { *p++ = hd->h4 >> 56; *p++ = hd->h4 >> 48; *p++ = hd->h4 >> 40; *p++ = hd->h4 >> 32; *p++ = hd->h4 >> 24; *p++ = hd->h4 >> 16; *p++ = hd->h4 >> 8; *p++ = hd->h4; } while(0);
    do { *p++ = hd->h5 >> 56; *p++ = hd->h5 >> 48; *p++ = hd->h5 >> 40; *p++ = hd->h5 >> 32; *p++ = hd->h5 >> 24; *p++ = hd->h5 >> 16; *p++ = hd->h5 >> 8; *p++ = hd->h5; } while(0);


    do { *p++ = hd->h6 >> 56; *p++ = hd->h6 >> 48; *p++ = hd->h6 >> 40; *p++ = hd->h6 >> 32; *p++ = hd->h6 >> 24; *p++ = hd->h6 >> 16; *p++ = hd->h6 >> 8; *p++ = hd->h6; } while(0);
    do { *p++ = hd->h7 >> 56; *p++ = hd->h7 >> 48; *p++ = hd->h7 >> 40; *p++ = hd->h7 >> 32; *p++ = hd->h7 >> 24; *p++ = hd->h7 >> 16; *p++ = hd->h7 >> 8; *p++ = hd->h7; } while(0);
