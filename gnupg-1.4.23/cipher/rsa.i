...
# 1 "../mpi/mpi-internal.h" 1
# 33 "../mpi/mpi-internal.h"
# 1 "../mpi/mpi-asm-defs.h" 1
# 34 "../mpi/mpi-internal.h" 2
...
secret(MPI output, MPI input, RSA_secret_key *skey )
{
    ...
    if (rr_nbits < 96)
      rr_nbits = 96;
    rr = mpi_alloc_secure ( (rr_nbits + (8*(4))-1)/(8*(4)) );
       ...
       int *npkey, int *nskey, int *nenc, int *nsig, int *r_usage )
{
    ...
    *nsig = 1;
    ...
    switch( algo ) {
      case 1: *r_usage = 1 | 2; return "RSA";
      case 2: *r_usage = 2; return "RSA-E";
      case 3: *r_usage = 1; return "RSA-S";
      default:*r_usage = 0; return ((void*)0);
    }
}
