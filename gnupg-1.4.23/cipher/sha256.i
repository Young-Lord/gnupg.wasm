  ...
  for(t=0;t<64;t++)
    {
      ...
      t1=h+(((((e))>>(6)) | (((e))<<(32-(6)))) ^ ((((e))>>(11)) | (((e))<<(32-(11)))) ^ ((((e))>>(25)) | (((e))<<(32-(25)))))+(((e) & (f)) ^ ((~(e)) & (g)))+k[t]+w[t];
...
sha256_final(SHA256_CONTEXT *hd)
{
 ...
 memset(hd->buf, 0, 56 );
    ...
    do { *p++ = hd->h5 >> 24; *p++ = hd->h5 >> 16; *p++ = hd->h5 >> 8; *p++ = hd->h5; } while(0);
    do { *p++ = hd->h6 >> 24; *p++ = hd->h6 >> 16; *p++ = hd->h6 >> 8; *p++ = hd->h6; } while(0);


    do { *p++ = hd->h7 >> 24; *p++ = hd->h7 >> 16; *p++ = hd->h7 >> 8; *p++ = hd->h7; } while(0);
