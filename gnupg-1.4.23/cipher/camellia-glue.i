...
camellia_setkey(void *c, const byte *key, unsigned keylen)
{
  ...
  static const char *selftest_failed=((void*)0);
  ...
  burn_stack
    ((19+34+34)*sizeof(u32)+2*sizeof(void*)
     +(4+32)*sizeof(u32)+2*sizeof(void*)
     +0+sizeof(int)+2*sizeof(void*)
     +3*2*sizeof(void*)
     );
