...
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/termios.h" 1 3
# 13 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/termios.h" 3
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/alltypes.h" 1 3
# 430 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/alltypes.h" 3
struct winsize { unsigned short ws_row, ws_col, ws_xpixel, ws_ypixel; };
# 14 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/termios.h" 2 3
...
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/termios.h" 1 3
struct termios {
 tcflag_t c_iflag;
 tcflag_t c_oflag;
 tcflag_t c_cflag;
...
# 22 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/termios.h" 2 3
...
cleanup(void)
{
    if( restore_termios ) {
 restore_termios = 0;
 if( tcsetattr(fileno(ttyfp), 2, &termsave) )
     g10_log_error("tcsetattr() failed: %s\n", strerror((*__errno_location())) );
    }
}
...
# 186 "ttyio.c"
 ...
 g10_log_error("cannot open tty `%s': %s\n",
                  tty_get_ttyname (), strerror((*__errno_location())) );
 exit(2);
    }
...
do_get( const char *prompt, int hidden )
{
    ...
    if( batchmode ) {
 g10_log_error("Sorry, we are in batchmode - can't get input\n");
 exit(2);
    }

    if (no_terminal) {
 g10_log_error("Sorry, no terminal at all requested - can't get input\n");
 exit(2);
    }
...
# 521 "ttyio.c"
 ...
 if( tcgetattr(fileno(ttyfp), &termsave) )
     g10_log_fatal("tcgetattr() failed: %s\n", strerror((*__errno_location())) );
 restore_termios = 1;
 term = termsave;
 term.c_lflag &= ~(0000010 | 0000020 | 0000040 | 0000100);
 if( tcsetattr( fileno(ttyfp), 2, &term ) )
     g10_log_fatal("tcsetattr() failed: %s\n", strerror((*__errno_location())) );
