...
# 34 "http.c" 2
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/sys/socket.h" 1 3
# 18 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/sys/socket.h" 3
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/alltypes.h" 1 3
# 424 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/alltypes.h" 3
struct iovec { void *iov_base; size_t iov_len; };
# 436 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/alltypes.h" 3
...
# 19 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/sys/socket.h" 2 3

# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/socket.h" 1 3
# 21 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/sys/socket.h" 2 3
...
# 369 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/sys/socket.h" 3
struct sockaddr {
...
# 37 "http.c" 2
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netinet/in.h" 1 3
...
# 10 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netinet/in.h" 2 3
...
# 62 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netinet/in.h" 3
...
# 233 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netinet/in.h" 3
struct ip_opts {
 struct in_addr ip_dst;
 char ip_opts[40];
};
# 251 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netinet/in.h" 3
struct ip_mreq {
...
# 38 "http.c" 2
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/arpa/inet.h" 1 3
# 11 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/arpa/inet.h" 3
uint32_t htonl(uint32_t);
uint16_t htons(uint16_t);
uint32_t ntohl(uint32_t);
uint16_t ntohs(uint16_t);
...
# 39 "http.c" 2
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/compat/netdb.h" 1 3



# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netdb.h" 1 3
# 13 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netdb.h" 3
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/alltypes.h" 1 3
# 14 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netdb.h" 2 3
...
# 55 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netdb.h" 3
...
# 132 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/netdb.h" 3
...
# 5 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/compat/netdb.h" 2 3
...
http_wait_response( HTTP_HD hd, unsigned int *ret_status )
{
    ...
    iobuf_ioctl (hd->fp_write, 1, 1, ((void*)0));
    iobuf_close (hd->fp_write);
    hd->fp_write = ((void*)0);
      ...
      STRLIST headers )
{
 ...
 return rc;
    ...
    rc = http_wait_response( hd, ((void*)0) );
    if( rc )
 http_close( hd );
...
do_parse_uri( PARSED_URI uri, int only_local_part )
{
    ...
    uri->port = 0;
    uri->params = uri->query = ((void*)0);


    if( strspn( p, "abcdefghijklmnopqrstuvwxyz" "ABCDEFGHIJKLMNOPQRSTUVWXYZ" "01234567890@" "!\"#$%&'()*+,-./:;<=>?[\\]^_{|}~") != n )
 return 46;
...
insert_escapes( byte *buffer, const byte *string, const byte *special )
{
    ...
    for( ; *string; string++ ) {
 if( strchr( "abcdefghijklmnopqrstuvwxyz" "ABCDEFGHIJKLMNOPQRSTUVWXYZ" "01234567890@" "!\"#$%&'()*+,-./:;<=>?[\\]^_{|}~", *string )
       ...
       struct http_srv *srv, STRLIST headers )
{
    ...
    ushort port;
    int rc;
    char *proxy_authstr=((void*)0),*authstr=((void*)0);
 ...
 if (rc)
   {
     g10_log_error("invalid HTTP proxy (%s): %s\n",proxy,g10_errstr(rc));
...
build_rel_path( PARSED_URI uri )
{
    ...
    n = insert_escapes( ((void*)0), uri->path, "%;?&" );

    for( r=uri->query; r; r = r->next ) {
 n++;
 n += insert_escapes( ((void*)0), r->name, "%;?&=" );
 n++;
 n += insert_escapes( ((void*)0), r->value, "%;?&=" );
    }
    n++;
 ...
 *p2++ = 0;
 ...
 return 0;
    ...
    if( (p2 = strpbrk( p, " \t" ) ) )
 *p2++ = 0;
    if( !(0 ? isdigit(p[0]) : ((unsigned)(p[0])-'0') < 10) || !(0 ? isdigit(p[1]) : ((unsigned)(p[1])-'0') < 10) || !(0 ? isdigit(p[2]) : ((unsigned)(p[2])-'0') < 10) || p[3] ) {
  ...
  struct http_srv *srv )
{
  ...
  int chosen = -1;
  int fakesrv = 0;
  struct srventry *srvlist = ((void*)0);
  int srvindex;
# 881 "http.c"
  if(srvlist==((void*)0))
    {
 ...
 return -1;
      srvlist->port=port;
      strncpy(srvlist->target,server,1025);
      srvlist->target[1025 -1]='\0';
      srvcount = 1;
      fakesrv = 1;
    }
      ...
      for(ai=res;ai;ai=ai->ai_next)
 {
   if((sock=socket(ai->ai_family,ai->ai_socktype,ai->ai_protocol))==-1)
     {
       g10_log_error("error creating socket: %s\n",strerror((*__errno_location())));
       freeaddrinfo(res);
       return -1;
     }
...
# 993 "http.c"
 ...
 g10_log_error("%s: Host not found\n",server);
