...
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/pwd.h" 1 3
# 18 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/pwd.h" 3
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/bits/alltypes.h" 1 3
# 19 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/pwd.h" 2 3
...
untilde(const char **name)
{
  ...
  ((void)(((*name)[0]=='~') || (__assert_fail("(*name)[0]=='~'", "fileutil.c", 112, __func__),0)));
...
make_filename( const char *first_part, ... )
{
    ...
    size_t n;
    const char *s;
    char *name, *p, *home=((void*)0);

    __builtin_va_start(arg_ptr, first_part) ;
    n = strlen(first_part)+1;
    while( (s=__builtin_va_arg(arg_ptr, const char *)) )
 n += strlen(s) + 1;
...
is_file_compressed( const char *s, int *ret_rc )
{
    ...
    struct magic_compress_s {
        ...
        { 3, { 0x42, 0x5a, 0x68, 0x00 } },
        { 3, { 0x1f, 0x8b, 0x08, 0x00 } },
