   ...
   PKT_public_key *pk, PKT_secret_key *sk )
{
    ...
    char *s=((void*)0);
    STRLIST pu=((void*)0);
    struct notation *nd=((void*)0);
    struct expando_args args;

    ((void)((sig->version>=4) || (__assert_fail("sig->version>=4", "sign.c", 70, __func__),0)));
    ...
    if((!(((sig)->sig_class == 0x1f) || (((sig)->sig_class & ~3) == 0x10) || ((sig)->sig_class == 0x18) || ((sig)->sig_class == 0x20) || ((sig)->sig_class == 0x30) || ((sig)->sig_class == 0x28))) && opt.sig_notations)
      nd=opt.sig_notations;
    else if( (((sig)->sig_class == 0x1f) || (((sig)->sig_class & ~3) == 0x10) || ((sig)->sig_class == 0x18) || ((sig)->sig_class == 0x20) || ((sig)->sig_class == 0x30) || ((sig)->sig_class == 0x28)) && opt.cert_notations )
 ...
 for(i=nd;i;i=i->next)
   {
     ...
     if(!i->altvalue)
       g10_log_error(gettext ("WARNING: unable to %%-expand notation " "(too large).  Using unexpanded.\n"));
 ...
 for(i=nd;i;i=i->next)
   {
    ...
    if( (!(((sig)->sig_class == 0x1f) || (((sig)->sig_class & ~3) == 0x10) || ((sig)->sig_class == 0x18) || ((sig)->sig_class == 0x20) || ((sig)->sig_class == 0x30) || ((sig)->sig_class == 0x28))) && opt.sig_policy_url )
      pu=opt.sig_policy_url;
    else if( (((sig)->sig_class == 0x1f) || (((sig)->sig_class & ~3) == 0x10) || ((sig)->sig_class == 0x18) || ((sig)->sig_class == 0x20) || ((sig)->sig_class == 0x30) || ((sig)->sig_class == 0x28)) && opt.cert_policy_url )
 ...
 if(!s)
   {
     g10_log_error(gettext ("WARNING: unable to %%-expand policy URL " "(too large).  Using unexpanded.\n"));
 ...
 xfree(s);
    ...
    if( (!(((sig)->sig_class == 0x1f) || (((sig)->sig_class & ~3) == 0x10) || ((sig)->sig_class == 0x18) || ((sig)->sig_class == 0x20) || ((sig)->sig_class == 0x30) || ((sig)->sig_class == 0x28))) && opt.sig_keyserver_url )
 ...
 if(!s)
   {
     g10_log_error(gettext ("WARNING: unable to %%-expand preferred keyserver URL" " (too large).  Using unexpanded.\n"));
...
{
    if (sig->version >= 4)
        do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (sig->version) & 0xff; } while(0);
    do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (sig->sig_class) & 0xff; } while(0);
    if (sig->version < 4) {
        u32 a = sig->timestamp;
        do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = ((a >> 24) & 0xff) & 0xff; } while(0);
        do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = ((a >> 16) & 0xff) & 0xff; } while(0);
        do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = ((a >> 8) & 0xff) & 0xff; } while(0);
        do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (a & 0xff) & 0xff; } while(0);
    }
    else {
        byte buf[6];
        size_t n;

        do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (sig->pubkey_algo) & 0xff; } while(0);
        do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (sig->digest_algo) & 0xff; } while(0);
        if (sig->hashed) {
            n = sig->hashed->len;
            do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = ((n >> 8)) & 0xff; } while(0);
            do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (n) & 0xff; } while(0);
            md_write (md, sig->hashed->data, n );
            n += 6;
        }
        else {
            do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (0) & 0xff; } while(0);
            do { if( (md)->bufcount == (md)->bufsize ) md_write( (md), ((void*)0), 0 ); (md)->buffer[(md)->bufcount++] = (0) & 0xff; } while(0);
            n = 6;
        }
  ...
  MD_HANDLE md, int digest_algo )
{
 ...
 digest_algo = md_get_algo(md);
    ...
    if (sk->is_protected && sk->protect.s2k.mode == 1002)
      ...
      {
        frame = encode_md_value( ((void*)0), sk, md, digest_algo );
        if (!frame)
          return 1;
    ...
    if (!rc && ((sk->pubkey_algo)==17)) {
     ...
     frame = encode_md_value (pk, ((void*)0), md, sig->digest_algo );
            if (!frame)
                rc = 1;
            else
        ...
        if (rc)
            g10_log_error (gettext ("checking created signature failed: %s\n"),
                         g10_errstr (rc));
        free_public_key (pk);
    }
    if( rc )
 ...
 if( opt.verbose ) {
     ...
     g10_log_info(gettext ("%s/%s signature from: \"%s\"\n"),
...
# 398 "sign.c"
      ...
      if(opt.personal_digest_prefs)
 {
  ...
  else if((opt.compliance==CO_PGP2) && sk->pubkey_algo == 1 && sk->version < 4 )
    {
...
only_old_style( SK_LIST sk_list )
{
 ...
 if( sk->pubkey_algo == 1 && sk->version < 4 )
     old_style = 1;
 else
     return 0;
    }
...
write_onepass_sig_packets (SK_LIST sk_list, IOBUF out, int sigclass )
{
    ...
    for (; skcount; skcount--) {
        ...
        free_packet (&pkt);
        if (rc) {
            g10_log_error ("build onepass_sig packet failed: %s\n",
                       g10_errstr(rc));
            return rc;
        }
    }
   ...
   int ptmode, u32 timestamp)
{
   ...
   g10_log_info (gettext ("WARNING: `%s' is an empty file\n"), fname);





        if ( tmpsize < (0xffffffff - 65536) )
          filesize = tmpsize;
        else
          filesize = 0;
   ...
   filesize = 0;
      ...
      filesize = opt.set_filesize? opt.set_filesize : 0;
    ...
    if (!opt.no_literal) {
        ...
        pt->mode = ptmode;
        pt->len = filesize;
        pt->new_ctb = !pt->len && !(opt.compliance==CO_RFC1991 || opt.compliance==CO_PGP2);
        pt->buf = inp;
        do { (&pkt)->pkttype = 0; (&pkt)->pkt.generic = ((void*)0); } while(0);
        ...
        if( (rc = build_packet (out, &pkt)) )
            g10_log_error ("build_packet(PLAINTEXT) failed: %s\n",
                       g10_errstr(rc) );
        pt->buf = ((void*)0);
    }
    else {
        ...
        while ((bytes_copied = iobuf_read(inp, copy_buffer, 4096)) != -1)
            if (iobuf_write(out, copy_buffer, bytes_copied) == -1) {
                rc = 22;
                g10_log_error ("copying input to output failed: %s\n",
                           g10_errstr(rc));
                break;
            }
        do { volatile char *_vptr=(volatile char *)(copy_buffer); size_t _vlen=(4096); while(_vlen) { *_vptr=(0); _vptr++; _vlen--; } } while(0);
    }
    ...
    int status_letter)
{
 ...
 if(opt.force_v3_sigs || (opt.compliance==CO_RFC1991 || opt.compliance==CO_PGP2))
   sig->version=3;
 ...
 if (sig->version >= 4)
   {
     ...
     mk_notation_policy_etc (sig, ((void*)0), sk);
   }
 ...
 if( !rc ) {
  ...
  print_status_sig_created ( sk, sig, status_letter);
     ...
     free_packet (&pkt);
     if (rc)
  g10_log_error ("build signature packet failed: %s\n",
                           g10_errstr(rc) );
 }
 if( rc )
     return rc;;
    ...
    int encryptflag, STRLIST remusr, const char *outfile )
{
    ...
    IOBUF inp = ((void*)0), out = ((void*)0);
    PACKET pkt;
    int rc = 0;
    PK_LIST pk_list = ((void*)0);
 ...
 g10_log_bug("multiple files can only be detached signed");
 ...
 goto leave;
    ...
    if((opt.compliance==CO_PGP2) && !only_old_style(sk_list))
      {
 g10_log_info(gettext ("you can only detach-sign with PGP 2.x style keys " "while in --pgp2 mode\n"));

 compliance_failure();
      }

    if(encryptflag && (rc=build_pk_list( remusr, &pk_list, 2 )))
      goto leave;
 ...
 if(opt.def_digest_algo)
   {
     if(!opt.expert &&
        select_algo_from_prefs(pk_list,PREFTYPE_HASH,
          opt.def_digest_algo,
          ((void*)0))!=opt.def_digest_algo)
   g10_log_info(gettext ("WARNING: forcing digest algorithm %s (%d)" " violates recipient preferences\n"),
...
# 887 "sign.c"
 ...
 iobuf_push_filter( inp, md_filter, &mfx );
    ...
    if( detached && !encryptflag && !(opt.compliance==CO_RFC1991 || opt.compliance==CO_PGP2) )
 afx.what = 2;
 ...
 if(compr_algo==-1)
   {
     ...
     if((compr_algo=
  select_algo_from_prefs(pk_list,PREFTYPE_ZIP,-1,((void*)0)))==-1)
       compr_algo=default_compress_algo();
   }
  else if(!opt.expert && pk_list
   && select_algo_from_prefs(pk_list,PREFTYPE_ZIP,
       compr_algo,((void*)0))!=compr_algo)
    g10_log_info(gettext ("WARNING: forcing compression algorithm %s (%d)" " violates recipient preferences\n"),
 ...
 if( compr_algo )
   push_compress_filter(out,&zfx,compr_algo);
    ...
    if (!detached && !(opt.compliance==CO_RFC1991 || opt.compliance==CO_PGP2)) {
 ...
 if( multifile ) {
  ...
  if( !inp )
    {
      g10_log_error(gettext ("can't open `%s': %s\n"),
         sl->d,strerror((*__errno_location())));
      rc = 24;
      goto leave;
    }
  ...
  iobuf_push_filter( inp, md_filter, &mfx );
  while( ( ((inp)->nofast || (inp)->d.start >= (inp)->d.len )? iobuf_readbyte((inp)) : ( (inp)->nbytes++, (inp)->d.buf[(inp)->d.start++] ) ) != -1 )
      ;
  iobuf_close(inp); inp = ((void*)0);
     }
     if( opt.verbose )
  putc( '\n', (stderr) );
 }
...
clearsign_file( const char *fname, STRLIST locusr, const char *outfile )
{
    armor_filter_context_t afx;
    progress_filter_context_t pfx;
    MD_HANDLE textmd = ((void*)0);
    IOBUF inp = ((void*)0), out = ((void*)0);
    PACKET pkt;
    int rc = 0;
    SK_LIST sk_list = ((void*)0);
    SK_LIST sk_rover = ((void*)0);
    int old_style = (opt.compliance==CO_RFC1991 || opt.compliance==CO_PGP2);
    int only_md5 = 0;
    u32 create_time=make_timestamp(),duration=0;
 ...
 old_style = only_old_style( sk_list );
    ...
    if((opt.compliance==CO_PGP2) && !only_old_style(sk_list))
      {
 g10_log_info(gettext ("you can only clearsign with PGP 2.x style keys " "while in --pgp2 mode\n"));
 ...
 ((void)((any) || (__assert_fail("any", "sign.c", 1147, __func__),0)));
 iobuf_writestr(out, "\n" );
    }
...
sign_symencrypt_file (const char *fname, STRLIST locusr)
{
 ...
 if(opt.ask_sig_expire && !opt.batch)
   ...
   duration=parse_expire_string(create_time,opt.def_sig_expire);
    ...
    rc = build_sk_list (locusr, &sk_list, 1, 1);
    if (rc)
 goto leave;
 ...
 goto leave;
    ...
    s2k->mode = (opt.compliance==CO_RFC1991 || opt.compliance==CO_PGP2)? 0:opt.s2k_mode;
    s2k->hash_algo = (opt.s2k_digest_algo?opt.s2k_digest_algo:2);

    algo = default_cipher_algo();
    if (!opt.quiet || !opt.batch)
        g10_log_info (gettext ("%s encryption will be used\n"),
      cipher_algo_to_string(algo) );
    cfx.dek = passphrase_to_dek( ((void*)0), 0, algo, s2k, 2, ((void*)0), ((void*)0));

    if (!cfx.dek || !cfx.dek->keylen) {
        rc = 26;
        g10_log_error(gettext ("error creating passphrase: %s\n"), g10_errstr(rc) );
        goto leave;
    }
 ...
 iobuf_push_filter (out, armor_filter, &afx);
    ...
    if (!(opt.compliance==CO_RFC1991 || opt.compliance==CO_PGP2)) {
 ...
 if( (rc = build_packet( out, &pkt )) )
     g10_log_error("build symkey packet failed: %s\n", g10_errstr(rc) );
 xfree(enc);
    }
     ...
     )
{
    ...
    ((void)(((sigclass >= 0x10 && sigclass <= 0x13) || sigclass == 0x1F || sigclass == 0x20 || sigclass == 0x18 || sigclass == 0x19 || sigclass == 0x30 || sigclass == 0x28) || (__assert_fail("(sigclass >= 0x10 && sigclass <= 0x13) || sigclass == 0x1F || sigclass == 0x20 || sigclass == 0x18 || sigclass == 0x19 || sigclass == 0x30 || sigclass == 0x28", "sign.c", 1380, __func__),0)));
                      ...
                      void *opaque )
{
 ...
 || (orig_sig->sig_class == 0x18 && !subpk))
    ...
    sig = copy_signature (((void*)0), orig_sig);
    sig->digest_algo = digest_algo;
