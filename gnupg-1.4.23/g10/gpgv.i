...
static ARGPARSE_OPTS opts[] = {
    ...
    { oKeyring, "keyring" ,2, ("take the keys from this keyring")},
    { oIgnoreTimeConflict, "ignore-time-conflict", 0,
                           ("make timestamp conflicts only a warning") },
    { oStatusFD, "status-fd" ,1, ("|FD|write status info to this FD") },
...
strusage( int level )
{
 ...
 break;
      case 1:
      case 40: p =
     gettext ("Usage: gpgv [options] [files] (-h for help)");
 break;
      case 41: p =
     gettext ("Syntax: gpgv [options] [files]\n" "Check signatures against known trusted keys\n");
...
main( int argc, char **argv )
{
    ...
    pargs.argv = &argv;
    pargs.flags= 1;
    while( optfile_parse( ((void*)0), ((void*)0), &configlineno, &pargs, opts) ) {
 switch( pargs.r_opt ) {
   ...
   case oLoggerFD: log_set_logfile( ((void*)0), pargs.r.ret_int ); break;
 ...
 set_packet_list_mode(1);
    ...
    if( !nrings )
        keydb_add_resource ("trustedkeys" "." "gpg", 8, 0);
...
struct keyserver_spec *
keyserver_match(struct keyserver_spec *spec) { return ((void*)0); }
...
struct keyserver_spec *parse_preferred_keyserver(PKT_signature *sig) {return ((void*)0);}
...
char *image_type_to_string(byte type,int string) {return ((void*)0);}
...
CIPHER_HANDLE cipher_open( int algo, int mode, int secure ) { return ((void*)0);}
void cipher_close( CIPHER_HANDLE c ) {}
...
byte *get_random_bits( size_t nbits, int level, int secure ) { return ((void*)0);}
...
void register_primegen_progress ( void (*cb)( void *, int), void *cb_data ) {}
MPI generate_secret_prime( unsigned nbits ) { return ((void*)0);}
MPI generate_public_prime( unsigned nbits ) { return ((void*)0);}
MPI generate_elg_prime( int mode, unsigned pbits, unsigned qbits,
                        MPI g, MPI **ret_factors ) { return ((void*)0);}
...
void tty_print_utf8_string( const byte *p, size_t n ) {}
void tty_print_utf8_string2( const byte *p, size_t n, size_t max_n ) {}
char *tty_get( const char *prompt ) { return ((void*)0);}
char *tty_get_hidden( const char *prompt ) {return ((void*)0); }
void tty_kill_prompt(void) {}
