...
# 1 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/stdio_ext.h" 1 3
# 14 "/home/yang/wasm/emsdk/upstream/emscripten/cache/sysroot/include/stdio_ext.h" 3
void _flushlbf(void);
...
_nl_expand_alias (const char *name)
{
  ...
  if (locale_alias_path == ((void*)0))
    locale_alias_path = "/home/yang/wasm/gnupg-1.4.23/prefix/share/locale";
...
# 237 "localealias.c"
 ...
 break;
      ...
      while (__isspace((unsigned char) cp[0]))
 ++cp;
 ...
 {
   alias = cp++;
   while (cp[0] != '\0' && !__isspace((unsigned char) cp[0]))
     ++cp;
