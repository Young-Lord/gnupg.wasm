...
{
  if (orig_prefix_arg != ((void*)0) && curr_prefix_arg != ((void*)0)
...
void
libintl_set_relocation_prefix (const char *orig_prefix_arg, const char *curr_prefix_arg)
{
...
# 418 "relocatable.c"
const char *
libintl_relocate (const char *pathname)
{
# 459 "relocatable.c"
  if (orig_prefix != ((void*)0) && curr_prefix != ((void*)0)
      && strncmp (pathname, orig_prefix, orig_prefix_len) == 0)
    {
      ...
      else if (((pathname[orig_prefix_len]) == '/'))
        {
